...
MagnificPopup.prototype = {
	...
	open: function(data) {
		...
		mfp._ariaHiddenElements = $('body').children().filter(':not(script)');
	...
	appendContent: function(newContent, type) {
		...
		if (type === 'image') {
			mfp.container.attr('aria-live', 'polite');
		}
		mfp.container.attr('tabindex', '-1');
...
$.magnificPopup.registerModule('gallery', {
	...
	options: {
		enabled: false,
		arrowMarkup: '<button title="%title%" aria-label="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',
		preload: [0,2],
